...
/* id, name, meta, basePrice, mrp, eta, rating, icon, colour, family, tags */
export const S = [
  ['ac1','AC service & repair','Split, window or cassette',599,899,'60 MINS','4.9','snow','blue','ac','ac aircon air conditioner cooling gas split window technician'],
  ['el1','Electrical work','Boards, fans, points, MCB',199,349,'45 MINS','4.9','zap','amber','elec','electrical electrician wiring switch board fan light mcb inverter socket short circuit'],
  ['pl1','Plumbing work','Taps, basins, drains, tanks',199,349,'45 MINS','4.8','drop','sky','plumb','plumbing plumber leak tap water drain pipe basin flush blockage seepage'],
  ['cl1','Room & bathroom cleaning','Per room or bathroom',449,699,'90 MINS','4.8','spray','green','clean','cleaning cleaner bathroom kitchen room mopping housekeeping maid toilet'],
  ['cl3','Full home cleaning','Whole flat, crew of 4',2499,3999,'5 HRS','4.9','spark','teal','home','cleaning deep clean home flat house housekeeping shifting'],
  ['cl4','Sofa & mattress cleaning','Foam extraction',899,1299,'2 HRS','4.8','spark','teal','uphol','sofa mattress carpet upholstery shampoo cleaning couch'],
  ['ap1','Appliance repair','Washer, fridge, geyser, oven',349,549,'75 MINS','4.7','machine','blue','appl','appliance repair washing machine fridge refrigerator geyser microwave oven chimney'],
  ['ap3','RO & water purifier','Filter, TDS, installation',349,499,'60 MINS','4.8','filter','sky','ro','ro water purifier aquaguard filter tds'],
  ['ho1','Carpentry','Doors, wardrobes, furniture',249,399,'60 MINS','4.8','hammer','violet','carp','carpenter carpentry furniture wood door wardrobe hinge lock drawer'],
  ['ho2','CCTV & security','Cameras, DVR, wiring',999,1499,'3 HRS','4.7','cam','violet','cctv','cctv camera security dvr surveillance'],
  ['ho3','Water tank cleaning','Drain, scrub, sanitise',799,1199,'2 HRS','4.8','tank','teal','tank','water tank cleaning sump overhead'],
  ['ho4','Pest control','Child and pet safe',1299,1999,'2.5 HRS','4.7','bug','green','pest','pest control cockroach termite ant bedbug mosquito rodent'],
  ...
  ['ot1','Painting','Interior, exterior, texture',12,18,'BOOK','4.7','brush','rose','paint','painting painter wall paint whitewash putty texture'],
...
export const CATS=[['Electrical','zap','amber','el1'],['Plumbing','drop','sky','pl1'],['AC repair','snow','blue','ac1'],['Cleaning','spark','teal','cl1'],
  ['Painting','brush','rose','ot1'],['Carpentry','hammer','violet','ho1'],['Appliances','machine','blue','ap1'],['Pest control','bug','green','ho4'],
  ['RO service','filter','sky','ap3'],['CCTV','cam','violet','ho2'],['Water tank','tank','teal','ho3'],['Deep clean','spray','green','cl3'],
